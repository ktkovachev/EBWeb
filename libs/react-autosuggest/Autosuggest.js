...
export default class Autosuggest extends Component {
  ...
  constructor({ alwaysRenderSuggestions }) {
    ...
    this.state = {
      ...
      highlightedSuggestionMethod: null
    };
    ...
    if (onSuggestionHighlighted) {
      ...
      if (highlightedSuggestion != prevHighlightedSuggestion) {
        onSuggestionHighlighted({
          ...
          method: this.state.highlightedSuggestionMethod
        });
      }
    }
  }
    ...
    const autowhateverInputProps = {
      ...
      onCompositionEnd: (event) => {
        ...
        this.setState({ composition: false }, () =>
          autowhateverInputProps.onChange.call(this, event)
        );
      },
      onChange: (event) => {
        const { value } = event.target;
        const shouldRender =
          shouldRenderSuggestions(value) && !this.state.composition;
        // console.log("Autosuggest onChange", value, shouldRender);
